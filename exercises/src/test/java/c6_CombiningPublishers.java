...
//        Flux<Integer> numbers = numberService1().concatWith(numberService2());
    ...
    public void need_for_speed() {
        ...
        //don't change below this line
        StepVerifier.create(stocks).expectNextCount(5).verifyComplete();
    }
    ...
    public void plan_b() {
        ...
        //don't change below this line
        StepVerifier.create(stocks).expectNextCount(6).verifyComplete();
    ...
    public void car_factory() {
        ...
        StepVerifier.create(producedCars)
                ...
                .expectRecordedMatches(cars ->
                        cars.stream().allMatch(car -> Objects.equals(car.chassis.getSeqNum(), car.engine.getSeqNum())))
                .verifyComplete();
    }
    ...
    public void cleanup() {
        ...
        Flux<String> stream = Flux.usingWhen(
                ...
                fluxString -> fluxString, //resource closure  -> closure in this case is same as Flux completion
